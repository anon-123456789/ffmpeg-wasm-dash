...
CONF_FLAGS=(
  ...
  -sFORCE_FILESYSTEM=1                     # allow accessing the virtual FS directly
  ...
  -sEXPORTED_RUNTIME_METHODS=$(node src/bind/ffmpeg/export-runtime.js),FS # exported built-in functions
  -lworkerfs.js
